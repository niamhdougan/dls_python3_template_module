...
def main():
    ...
    parser = ArgumentParser(
        description="Command line tool adding dls_python3_template_module to python module"
    )
    parser.add_argument(
        "--version", action="store_true", help="Print the current version of dls_python3_template_module"
    )
    parser.add_argument(
    ...
    if args.version:
        ...
        dls_python3_template_module_path = os.path.dirname(os.path.abspath(__file__))
        # Write _version_git.py with descriptive header
        with open(os.path.join(dls_python3_template_module_path, "_version_git.py")) as f:
            lines = f.readlines()
        header = (
            """# Compute a version number from a git repo or archive

# This file is released into the public domain. Generated by:
# dls_python3_template_module-%s (https://github.com/niamhdougan/dls_python3_template_module)
"""
            % __version__
        )
